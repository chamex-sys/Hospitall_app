            ...
            <div class="row justify-content-center">
              <div class="col-md-4 py-3 py-md-0">
                <div class="card-service wow fadeInUp">
                  ...
                  <p><span>Describe</span> your symptomes </p>
                </div>
              </div>
              <div class="col-md-4 py-3 py-md-0">
                <div class="card-service wow fadeInUp">
...
<!-- @include('user.appointment') -->
      <!-- .page-section -->
    <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_imag
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8 wow fadeInUp">
        ...
        <div class="text-lg">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt neque sit, explica
          <p>Expedita iusto sunt beatae esse id nihil voluptates magni, excepturi distinctio impe
        </div>
      </div>
